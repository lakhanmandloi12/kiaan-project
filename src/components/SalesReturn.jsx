...
const SalesReturn = () => {
    ...
    return (
        <div className="container-fluid py-4 px-3" style={{ backgroundColor: '#f7f7f7', minHeight: '100vh' }}>
            <div className="d-flex justify-content-between align-items-center flex-wrap gap-4 mb-4">
                <div>
                    <h5 className="fw-bold">Sales Return</h5>
                                ...
                                >
                                    ...
                                    <td>
                                        <div className="d-flex gap-2 justify-content-center">
                                            <button
                                                className="btn btn-warning btn-sm text-white py-1 px-2"
                                                onClick={() => handleEditClick(item)}
                                            >
                                                <FaEdit size={14} />
                                            </button>
                                            <button
                                                className="btn btn-danger btn-sm text-white py-1 px-2"
